  ...
  return (
    <main className="mx-auto flex max-w-md flex-col gap-6 px-4 py-8">
      ...
      <p className="text-center text-xs leading-relaxed text-slate-500">
        ...
        ตัวละครและบทสนทนาทั้งหมดเป็นเรื่องสมมติเพื่อการศึกษา —
        เว็บนี้เป็นโครงการอิสระ ไม่มีส่วนเกี่ยวข้องกับหน่วยงานรัฐ ตำรวจ
        หรือธนาคารใดๆ ข้อความที่พิมพ์ระหว่างซ้อมถูกส่งไปประมวลผลที่ Google
        Gemini และสถิติการใช้งานเก็บแบบไม่ระบุตัวตนด้วย Umami
      </p>
    </main>
  );
}
